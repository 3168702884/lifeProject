...
import { barrierFree } from './services';
    ...
    <PageContainer>
      <ProTable
        ...
        request={async (params, sorter, filter) => {
          ...
          const barrierFreedata = await barrierFree();
          setrowlength(barrierFreedata.length);
          return {
            data: barrierFreedata,
            // success 请返回 true，
        ...
        toolBarRender={() => [
          <Button
            ...
            disabled={rowlength < 3 ? false : true}
          >
            新建
          </Button>,
        ]} //渲染工具栏
